...
def readargs():
    ...
    parser.add_argument('-p', '--path', nargs='*',help = 'Backup only hosts which have destination path specified in this option. It can be used with "-r" option')
    ...
    parser.add_argument('--snapshot', metavar='LABEL', nargs='?', const="custom", help = 'Create snapshot by label. If omitted, label will be "custom"')
